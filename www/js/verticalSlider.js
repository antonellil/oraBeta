...
$.widget( "mobile.slider", $.mobile.widget, {
	...
	_create: function() {
		...
		var sliderOrientation = control.attr( "sliderOrientation") || "horizontal";

		// prevent screen drag when slider activated
		$( document ).bind( "vmousemove", function( event ) {
			if ( self.dragging && (sliderOrientation == 'vertical')) {
	...
	refresh: function( val, isfromControl, preventInputUpdate ) {
		...
		if ( !preventInputUpdate ) {
			...
			if(valueChanged && (sliderOrientation == "vertical")){
				$('#resultsSliderWrap').trigger('resultsChange',[newval]);
			}

			if(valueChanged && (sliderOrientation != "vertical")){
				$('#timeSliderWrap').trigger('timeChange',[newval]);
			}
		}
	},
